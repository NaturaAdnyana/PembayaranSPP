	...
	<div class="about">
		<div class="about_box" align="center">
			<div class="about_me">
				...
				<h2>I'm <span>Natura Adnyana</span></h2>
				<hr style="width: 250px; margin: 5px;">
				<p>
					Semoga halaman ini dibaca Buk Mitha <i class="fas fa-smile-beam"></i><br>
					Ibuk Mitha yang saya hormati, ini hasil web saya selama sebulan. Saya tidak menyangka bisa membuat website seperti ini buk... Saya sangat bangga, bisa membuat web seperti ini dengan mandiri saking rasa ingin tau yang berlebihan<i class="fas fa-laugh-wink"></i>. Tiap hari saya bikin website ini sampai begadang. Dan rasanya hasilnya benar-benar bikin saya puas<i class="fas fa-smile-beam"></i>. Bahkan saat web ini selesai, rasanya pingin nangis buk<i class="fas fa-grin-squint"></i>. Ini semua karena berkat Ibu Mitha. Rasanya saya tidak sia-sia belajar di RPL ini apalagi diajarin sama ibuk. Buk Mitha emang terbaik. Terima kasih telah menuntut saya sampai saya bisa membuat website seperti ini<i class="fas fa-sad-cry"></i><br>
					Dan iya.. Ini website pertama yang benar-benar saya tuntaskan. Saya janji bakal membuat yang lebih baik. Dan saya akan buat yang lebih baik dari ibuk. Liat saja nanti<i class="fas fa-grin-squint"></i></i>
				</p>
				<br>
				<a class="social1" href="https://www.facebook.com/inoue.natsura"><i class="fab fa-facebook-f"></i></i></a>
				<a class="social2" href="https://www.instagram.com/natkunn_/"><i class="fab fa-instagram"></i></a>
				<a class="social3" href="mailto:natura538@gmail.com"><i class="fas fa-at"></i></a>
			</div>
		</div>
	</div>
